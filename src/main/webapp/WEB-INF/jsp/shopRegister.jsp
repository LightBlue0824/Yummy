...
<div class="container" style="padding-top: 60px;">
    <div class="form_container center-block">
        <h2>注册<small>欢迎商户入驻Yummy!</small></h2>
        <form class="form" method="post">
            ...
            <div class="form-group">
                ...
                <textarea id="brief" name="brief" class="form-control" rows="3" placeholder="brief"></textarea>
            </div>
            <div class="form-group">
                <span id="helpLoginBlock" class="help-block">已有Yummy账户</span>
                <a class="btn btn-default pull-left" aria-describedby="helpLoginBlock" href="shop/login">去登录</a>
                <button id="btn_submit" type="submit" class="btn btn-primary pull-right" onclick="submit()">注册</button>
            </div>
        </form>
    </div>
</div>
